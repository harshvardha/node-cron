                            ...
                            <Container>
                                ...
                                <Row className="justify-content-center">
                                    <Col xs={12} md={8} lg={8} className="buy-progressbar">
                                        ...
                                        <ProgressBar now={20} className="mt-2 mb-2" />
                                        <Row>
                                        ...
                                        <Row>
                                            <Col xs={12} md={10} lg={7}>
                                                <Row style={{ marginLeft: '4rem' }} className="mt-3">
                                                    <Col xs={12} md={12} lg={5}>
                                                        ...
                                                        <div className="d-grid">
                                                            {/* <button className="btn btn-primary Firstblogbtn1" type="button">$1000</button> */}
                                                            <input type="number" className="form-control Firstblogbtn1" placeholder="$1000" />
                                                        </div>
                                                    </Col>
                                                ...
                                                <Row style={{ marginLeft: '4rem' }} className="mt-3">
                                                    <Col xs={12} md={12} lg={5}>
                                                        ...
                                                        <div className="d-grid">
                                                            ...
                                                            <select className="form-control Firstblogbtn1">
                                                ...
                                                <Row style={{ marginLeft: '4rem' }} className="mt-5">
                                                    <Col xs={12} md={12} lg={5}>
                                                        <div className="d-grid">
                                                            <button className="btn btn-primary Firstblogbtn fw-bold" type="button"><span className="buy-astor-text-btn">BUY ASTOR</span></button>
                                                        </div>
                                                    </Col>
                                                </Row>
                                                ...
                                                <Card className='FirstblogBlack mt-3 p-2'>
                                                    <Card.Body>
                                                        ...
                                                        <Row className='mt-2'>
                                                            ...
                                                            <Col xs={12} md={12} lg={6}>
                                                                <Card.Text className="text-start">1/5 </Card.Text>
                                                            </Col>
                                                        </Row>
                                                        <Row className='mt-2'>
                                                            <Col xs={12} md={12} lg={6}>
                                                        ...
                                                        <Row className='mt-2'>
                                                            ...
                                                            <Col xs={12} md={12} lg={6}>
                                                                <Card.Text className="text-start">$ 1000 </Card.Text>
                                                            </Col>
                                                        </Row>
                                                        <Row className='mt-2'>
                                                            <Col xs={12} md={12} lg={6}>
                                                            ...
                                                            <Col xs={12} md={12} lg={6}>
                                                                <Card.Text className="text-start"> BNB </Card.Text>
                                                            </Col>
                                                        </Row>
                                                        <Row className='mt-2'>
                                                            <Col xs={12} md={12} lg={6}>
