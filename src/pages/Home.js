...
import bgimg982 from '../image/bg-img982.png';
import exchange from '../image/exchange.png';
import gateway from '../image/gateway.png';
import tokenW from '../image/token.png';
import debit from '../image/debit.png';
import ImageVideo from '../image/ImageVideo.png';
import BuyImg from '../image/boy-img.png';
...
const Home = (props) => {
  ...
  return (
    <>
      ...
      <Container fluid>
        <Link to={"/buy-astor"}>
            <img src={HeroSection} alt={HeroSection} className="img-fluid hand" style={{marginTop:"-78px"}}/>
        </Link>
      </Container>
        ...
        <Container fluid className='card-sec overflow-hidden'>
                <Row>
                    <Col lg={7}>
                        <img src={bgimg982} alt={bgimg982} className="img-fluid" style={{marginTop:"-20%"}}/>
                    ...
                    <Col lg={4}>
                        <Card className="bg-transparent border-light mt-5 pt-5">
                            <Card.Body>
                                ...
                                <Card.Title className='futer-text fs-2 fw-bolder text-blue2'> Future of Defi has never been so Bright </Card.Title>
                    ...
                    <Col md={12} lg={12} className="exchange-card-box">
                        <Container>
                            <Row>
                                <div className='home-card-box'>
                                    <img src={exchange} alt={exchange} />
                                    <h4 className='text-blue2 text-center fw-bold mt-3'>Decentralized Exchange</h4>
                                    <p className='opacity8'>Join the Decentralized world to ensure the safety of your funds while reducing the risk of hacks.</p>
                                </div>
                                <div className='home-card-box'>
                                    <img src={gateway} alt={gateway} />
                                    <h3 className='text-blue2 text-center fw-bold mt-3'>Fiat Payment Gateway</h3>
                                    <p className='opacity8'>The first decentralized fiat payment gateway allows you to exchange crypto seamlessly and safely.</p>
                                </div>
                                <div className='home-card-box'>
                                    <img src={tokenW} alt={tokenW} />
                                    <h3 className='text-blue2 text-center fw-bold mt-3'>Token Launch Pad</h3>
                                    <p className='opacity8'>Join the Decentralized world to ensure the safety of your funds while reducing the risk of hacks.</p>
                                </div>
                                <div className='home-card-box'>
                                    <img src={debit} alt={debit} />
                                    <h3 className='text-blue2 text-center fw-bold mt-3'>Cryptolution Debit Card</h3>
                                    <p className='opacity8'>Join the Decentralized world to ensure the safety of your funds while reducing the risk of hacks.</p>
                                </div>
                            </Row>
                        </Container>
        ...
        <Container fluid className='overflow-hidden'>
            <img src={ImageVideo} alt={ImageVideo} className="img-fluid hand"/>
        ...
        <Container fluid className='card-sec overflow-hidden' style={{minHeight:850}}>
                <Row>                    
                    <Col lg={4} className="ps-5">
                        <Card className="bg-transparent border-light mt-5 pt-5">
                            <Card.Body>
                                <Card.Text className='fs-6 fw-bold '> ― THE ECOSYSTEM</Card.Text>
                                <Card.Title className='futer-text fs-2 fw-bolder text-blue2'>The Astor Token is the driving force behind Cryptolution</Card.Title>
                                <Card.Text> ASTOR Token is built on the Binance Smart Chain (BEP-20). Issued by Cryptolution Swap, a cross-chain aggregation platform integrating NFT, DEX, Farming, and the first decentralized Fiat Payment Gateway.  </Card.Text>                               
                            </Card.Body>
                        </Card>
                    </Col>
                    <Col lg={7} className="mt-3">
                        <img src='image/card-img.png' alt='image/card-img.png' className="img-fluid mt-5"/>
                        {/* <Button className='read-btn position-absolute rounded-pill btn-light border shadow-lg'> Read more </Button> */}
                    </Col>
                    <Col md={12} lg={12} className="exchange-card-box">
                        <Container>
                            <Row>
                                <div className='home-card-box'>
                                    <img src={"image/lock.png"} alt={'image/lock.png'} />
                                    <h4 className='text-blue2 text-center fw-bold mt-3'>Stake Astor and Earn Profit</h4>
                                    <p className='opacity8'>Lock your Astor Tokens today and gain value on every single transaction made on Cryptolution.</p>
                                </div>
                                <div className='home-card-box'>
                                    <img src={'image/light.png'} alt={'image/light.png'} />
                                    <h3 className='text-blue2 text-center fw-bold mt-3'>Highly Accessible Platform</h3>
                                    <p className='opacity8'>Convenient access to our platform from all devices. Connecting your wallet has never been easier.</p>
                                </div>
                                <div className='home-card-box'>
                                    <img src={'image/grow.png'} alt={'image/grow.png'} />
                                    <h3 className='text-blue2 text-center fw-bold mt-3'>Grow with Astor</h3>
                                    <p className='opacity8'>Our efficient referral system offers users a variety of earning options on the Astor Token.</p>
                                </div>
                                <div className='home-card-box'>
                                    <img src={'image/invest.png'} alt={'image/invest.png'} />
                                    <h3 className='text-blue2 text-center fw-bold mt-3'>Invest with Astor</h3>
                                    <p className='opacity8'>Get exclusive offers on staking, trading, and token exchange. Take advantage of our VIP Program for loyal token holders.</p>
                                </div>
                                <Col lg={12} className="text-center">
                                    <Link to={"/buy-astor"} type="button" className="Firstblogbtnblue ms-5 btn btn-outline-success">
                                        BUY ASTOR
                                    </Link>
                                </Col>
                            </Row>
        ...
        <Container fluid className='mt-5'>
            <Row className='text-center mt-5'> 
                <Col lg={4}></Col>
                <Col lg={4}>
                    <h6>- PRESALE INFORMATION</h6>
                    <h3 className='text-blue2 text-center fw-bold'>Cryptolution Presale<br/>of Astor</h3>
                    <p className='opacity8 p-3'>Drive your earnings upwards by participating in our ongoing Presale. Get your early bird discount and buy Astor now!</p>
                </Col>            
            </Row>
            ...
            <Row className=' mb-5 pb-5'>
                ...
                <Card className="bg-transparent border-light">
                    <Card.Body className='pt-lg-5 mt-lg-5'>
                        <Card.Text className='fs-7 fw-bolder mt-lg-5 mt-md-5 pt-5'> ― TOKENOMICS </Card.Text>
                           <Card.Title className='Card-Title fs-1 fw-bold text-blue2'>Simple model with defined usage and rocketing value </Card.Title>
                           <Card.Text className='opacity8'> The Astor Token will be used for the Cryptolution project to gain rewards via participating variety of farms, lottery, and liquidity pools. Astor is the main token in the Cryptolution platform. It’s the intersection of three markets, (Defi; NFT; Staking) each of which has strong growth potential. </Card.Text>
                           <Button className="btn2 color-text bg-light ms-2 py-2 ps-3 pe-5 text-responsive rounded-pill shadow text-blue2 fw-bold" type="button">
                            <img src='image/bscscan.png' className='img-fluid me-2' alt='avt' />
                           BSCSCAN</Button>
                           <Button className="btn2 color-text bg-light ms-2 mt-lg-0 mt-3 py-2 ps-5 pe-5 text-responsive rounded-pill shadow text-blue2 fw-bold" type="button">WHITEPAPER</Button>
                           <Button className="btn2 color-text bg-light ms-2 mt-3 py-2 ps-5 pe-5 text-responsive rounded-pill shadow text-blue2 fw-bold" type="button">AUDIT</Button>
                        </Card.Body>
                    </Card>
                </Col>
            </Row>
        ...
        <Container fluid>
            ...
            <Col lg={4}>
                <Card className="bg-transparent border-light text-center mt-lg-5 pt-5">
                    <Card.Body>
                        <Card.Text className='fs-7 fw-bold'> ― THE ECOSYSTEM </Card.Text>
                        <Card.Title className='futer-text fs-2 fw-bolder text-blue2'> Our roadmap gives perspective into the future </Card.Title>
                        <Card.Text className='pt-2 opacity8'> Achieving goals requires a clear and reliable business plan. Visualizing our objectives and strategies to ensure prosperity and progress is the key method that our organization uses. </Card.Text>
                    </Card.Body>
                </Card>
                </Col>
            <Col md={4}></Col>
        ...
        <Container fluid className='overflow-hidden' style={{backgroundImage:'url('+BuyImg+')'}}>
            <Row className="avt-card mt-5 mb-2" >
                <Col md={12} className="mt-5">
                    <Row>
                        ...
                        <Col md={6}>
                            <Card className='avt-child-card'>
                                <Card.Body >
                                    <Card.Title className='fs-2 fw-bold rounded text-center'>Stay connected  and  <span className='sp-text fw-bold text-blue2'>earn together.</span></Card.Title>
                                </Card.Body>
                            </Card>
                        </Col>
                        <Col md={3}></Col>
                    ...
                    <Row className='my-lg-5 mb-5 pb-5'>
                        ...
                        <Col md={2} className='stay-card'>
                            <Card className='border-light'>
                                <Card.Img src="image/one.png" className='num-img w-25 position-absolute' alt='avtar' />
                                <Card.Body>
                                    <Card.Title className='card-text1 fw-bold fs-6 pt-4 text-center text-blue2'>Connect your Wallet</Card.Title>
                                </Card.Body>
                            </Card>
                        </Col>
                        <Col md={2} className='stay-card'>
                            <Card className='border-light'>
                                ...
                                <Card.Body>
                                    <Card.Title className='card-text1 fw-bold fs-6 pt-4 text-center text-blue2'>Buy Astor Token</Card.Title>
                                </Card.Body>
                            </Card>
                        </Col>
                        <Col md={2} className='stay-card'>
                            <Card className='border-light'>
                                ...
                                <Card.Body>
                                    <Card.Title className='card-text1 fw-bold fs-6 pt-4 text-center text-blue2'>Share your  referral link</Card.Title>
                                </Card.Body>
                            </Card>
                        </Col>
                        <Col md={2} className='stay-card'>
                            <Card className='border-light'>
                                ...
                                <Card.Body>
                                    <Card.Title className='card-text1 fw-bold fs-6 pt-4 text-center text-blue2'>Sit back and collect</Card.Title>
                                </Card.Body>
                            </Card>
                        </Col>
                    </Row>
                    ...
                    <Col lg={12} className="text-center">
                        <button type="button" className="Firstblogbtnblue ms-5 btn btn-outline-success col-md-1">DETAILS</button>
                        <button type="button" className="Firstblogbtnblue ms-5 btn btn-outline-success col-md-1">JOIN</button>
                    </Col>
                </Col>
            </Row>
        </Container>
                    ...
                    <Row>
                        ...
                        <Card className="bg-transparent border-light ms-lg-5 mt-lg-5 pt-5">
                                <Card.Body>
                                    ...
                                    <Card.Title className='Card-Title fs-1 fw-bold text-blue2'> Latest News and Media </Card.Title>
                                    <Card.Text className="opacity8">Follow us on social media and sign up for our newsletter today so you can learn more about Cryptolution and feel connected to our mission. </Card.Text>
                                </Card.Body>
                            </Card>
                        </Col>
                    </Row>
        ...
        <Container fluid>
            <Row>
                ...
                <Card className="bg-transparent border-light py-3 py-5 my-lg-5 my-md-4">
                    <Card.Body>
                       <Card.Text className='fs-6 fw-bolder pe-lg-5 me-lg-5'>― OUT GLOBAL COMMUNITY</Card.Text>
                       <Card.Title className='Card-Title fs-1 fw-bold text-blue2'> Connect with Cryptolution and Follow Innovation </Card.Title>
                        <Card.Text className='pe-lg-5 me-lg-5 opacity8'>Join the Cryptolution family and help us lead the way to create a tokenized world. Subscribe to our social media channels and stay tuned for news and updates. </Card.Text>
                     </Card.Body>
                </Card>
                </Col>
            </Row>
        </Container>
        <Container fluid className='overflow-hidden' style={{backgroundImage:'url(image/doc-img.png)'}}>
            <Row className="avt-card mt-5 mb-2" >
                <Col md={12} className="mt-5">
                    <Row>
                        <Col md={3}></Col>
                        <Col md={6}>
                            <Card className='avt-child-card'>
                                <Card.Body >
                                    <Card.Title className='fs-2 fw-bold rounded text-center'>Additional <span className='sp-text fw-bold text-blue2'>documents.</span></Card.Title>
                                </Card.Body>
                            </Card>
                        </Col>
                        <Col md={3}></Col>
                    ...
                    <Row className='mb-5'>
                        <Col md={3} className='me-4'></Col>
                        <Col md={2}>
                            <button type="button" className="Firstblogbtnblue btn btn-outline-success col-md-11">WHITEPAPER</button>
                        </Col>
                        <Col md={2}>
                            <button type="button" className="Firstblogbtnblue btn btn-outline-success col-md-11">PRESENTATION</button>
                        </Col>
                        <Col md={2}>
                            <button type="button" className="Firstblogbtnblue btn btn-outline-success col-md-11">AUDIT</button>
                        </Col>                    
                    </Row>                    
                </Col>
            </Row>
            ...
            <Col md={3}></Col>
                <Col md={6}>
                    <Card className='doc-child-card border-0 bg-light'>
                        <Card.Body >
                            <Card.Title className='futer-text fs-1 fw-bold rounded text-center text-blue2'>Get the important news first!</Card.Title>
                            <Row className='ms-lg-4 ps-lg-2 ps-md-2'>  
                                ...
                                <Button variant="" className='button-card rounded-pill text-white fw-bold py-2 Firstblogbtnblue'>
                                    SUBSCRIBE
                                </Button>{' '}
                                </div>
                            </div>
                            ...
                            <p className='text-center pt-3 opacity8'>Subscribe our newsletter to get access to early news.</p>
                        </Card.Body>
                    </Card>
                </Col>
                <Col md={3}></Col>
